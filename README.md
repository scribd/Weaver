...
Add `pod 'WeaverDI', '~> 0.9.5'` to the `Podfile`.

#### Carthage

Add `github "scribd/Weaver" ~> 0.9.5` to the `Cartfile`.

#### SwiftPM

Add `.package(url: "https://github.com/scribd/Weaver.git", from: "0.9.5")` to the dependencies section of the `Package.swift` file.
